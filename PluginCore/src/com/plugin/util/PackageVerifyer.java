...
public class PackageVerifyer {
        ...
        try {
            ...
            if (simpleMode) {
                ...
                if (certs == null) {
                    ...
                    PaLog.e("INSTALL_PARSE_FAILED_NO_CERTIFICATES");
                    return null;
                }
                if (true) {
                    PaLog.d(TAG, "File " + sourcePath + ": entry=" + jarEntry
                            + " certs=" + (certs != null ? certs.length : 0));
                    if (certs != null) {
                        final int N = certs.length;
                        for (int i=0; i<N; i++) {
                            PaLog.d(TAG, "  Public key: "
                ...
                while (entries.hasMoreElements()) {
                    ...
                    Certificate[] localCerts = loadCertificates(jarFile, je,
                            readBuffer);
                    if (true) {
                        PaLog.d(TAG, "File " + sourcePath + " entry " + je.getName()
                                + ": certs=" + certs + " ("
                    ...
                    if (localCerts == null) {
                        ...
                        for (int i=0; i<certs.length; i++) {
                            ...
                            if (!found || certs.length != localCerts.length) {
                                ...
                                PaLog.e("INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES");
                                return null;
                            }
                        }
                    }
            ...
            PaLog.e(TAG, "Exception reading " + sourcePath, e);
            PaLog.e("INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING");
            return null;
        } catch (IOException e) {
            PaLog.e(TAG, "Exception reading " + sourcePath, e);
            PaLog.e("INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING");
            ...
            PaLog.e(TAG, "Exception reading " + sourcePath, e);
            PaLog.e("INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION");
            return null;
        }
    ...
    private static Certificate[] loadCertificates(JarFile jarFile, JarEntry je,
        ...
        try {
            ...
            PaLog.e(TAG, "Exception reading " + je.getName() + " in "
                    + jarFile.getName(), e);
        } catch (RuntimeException e) {
            PaLog.e(TAG, "Exception reading " + je.getName() + " in "
                    + jarFile.getName(), e);
