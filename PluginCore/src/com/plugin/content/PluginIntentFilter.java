...
public class PluginIntentFilter implements Serializable {
    ...
    private static final String DATE_STR = "data";
    private static final String MAIN_TAG = "android.intent.action.MAIN";
    ...
    public boolean readFromXml(String tagName, XmlPullParser parser) throws XmlPullParserException,
            IOException {
        ...
        if (tagName.equals(ACTION_STR)) {
        ...
        } else if (tagName.equals(DATE_STR)) {
            ...
            PaLog.d("IntentFilter", "Not a IntentFilter tag : ", tagName);
        }
        return isMain;
    }
